        ...
        <div id="content">
            <div id="gallerycontainer">
                <div style="margin:0 auto; padding:30px 20px 20px 20px; width:820px;">
                    ...
                    <img class = "image" src="images/oldbus.jpg" alt="" >
                    <div id="fb">
                        <?php include_once("php_includes/fblike.php"); ?>
                    </div>
                    <h3>History</h3>
                    <p class="text"> Photo taken on October 16, 1993. Napat Transit (now Dimple Star Transport) NVR-963<br>
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="missionDesc" >To provide superior transport service to Metro Manila and Mindoro Province commuters.
                            </td>
                            <td class="visionDesc">To lead the bus transport industry through its innovation service to the riding public.
                            </td>
